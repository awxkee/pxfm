...
use pxfm::{
    ...
    f_cospi, f_cospif, f_erf, f_erfcf, f_erff, f_exp, f_exp2, f_exp2f, f_exp2m1, f_exp2m1f,
    ...
    f_log10p1f, f_logf, f_pow, f_powf, f_sin, f_sincf, f_sincos, f_sincosf, f_sinf, f_sinh,
