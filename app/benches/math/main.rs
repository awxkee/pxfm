...
use pxfm::{
    ...
    f_exp10m1, f_exp10m1f, f_expf, f_expm1, f_expm1f, f_j1, f_log, f_log1pf, f_log2, f_log2f,
    f_log2p1f, f_log10, f_log10f, f_log10p1f, f_logf, f_pow, f_powf, f_sin, f_sincos, f_sincosf,
    f_sinf, f_sinhf, f_sinpi, f_sinpif, f_tan, f_tanf, f_tanhf, f_tanpi, f_tanpif, powf,
};
