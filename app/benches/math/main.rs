...
use pxfm::{
    exp, f_acos, f_acosf, f_acospi, f_acospif, f_asin, f_asinf, f_asinpif, f_atan, f_atan2,
    ...
    f_exp10m1f, f_expf, f_expm1, f_expm1f, f_j1, f_log, f_log1pf, f_log2, f_log2f, f_log2p1f,
