...
use pxfm::{
    ...
    f_atanh, f_atanhf, f_atanpi, f_atanpif, f_cbrt, f_cbrtf, f_compound, f_compoundf, f_cos,
    f_cosf, f_cosh, f_coshf, f_cospi, f_cospif, f_erf, f_erfc, f_erfcf, f_erff, f_exp, f_exp2,
    f_exp2f, f_exp2m1, f_exp2m1f, f_exp10, f_exp10f, f_exp10m1, f_exp10m1f, f_expf, f_expm1,
    f_expm1f, f_hypot, f_j1, f_log, f_log1p, f_log1pf, f_log2, f_log2f, f_log2p1, f_log2p1f,
    f_log10, f_log10f, f_log10p1, f_log10p1f, f_logf, f_pow, f_powf, f_sin, f_sinc, f_sincf,
