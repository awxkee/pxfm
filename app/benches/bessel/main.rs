...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("pxfm: i1ef", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_i1ef(i as f32 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: i0ef", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_i0ef(i as f32 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: i0e", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_i0e(i as f64 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k2f", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k2f(i as f32 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k1f", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k1f(i as f32 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k0ef", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k0ef(i as f32 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k0f", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k0f(i as f32 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k0e", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k0e(i as f64 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k0", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k0(i as f64 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k1e", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k1e(i as f64 / 50.0));
            }
        })
    });
    ...
    c.bench_function("pxfm: k1", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_k1(i as f64 / 50.0));
            }
        })
    });
    ...
    c.bench_function("libm::j1f", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(libm::j1f(i as f32 / 10.0));
            }
        })
    });
    ...
    c.bench_function("libm::y0f", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(libm::y0f(i as f32 / 10.));
            }
        })
    });
    ...
    c.bench_function("libm::y1f", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(libm::y1f(i as f32 / 10.));
            }
        })
    });
    ...
    c.bench_function("pxfm: f_jincpif", |b| {
        b.iter(|| {
            for i in 1..1000 {
                black_box(pxfm::f_jincpif(i as f32 / 10.0));
            }
        })
    });
