...
use pxfm::{
    f_acosf, f_asinf, f_cbrtf, f_cosf, f_coshf, f_cospif, f_exp2f, f_exp2m1f, f_exp10f, f_expf,
    f_expm1f, f_log2f, f_log10f, f_logf, f_powf, f_sinf, f_sinhf, f_sinpif, f_tanf, f_tanhf,
    f_tanpif,
};
use rug::ops::Pow;
