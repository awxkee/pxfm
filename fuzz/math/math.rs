...
use pxfm::{
    ...
    f_log10p1, f_log10p1f, f_logf, f_rcbrt, f_rcbrtf, f_sec, f_secf, f_sin, f_sincos, f_sinf,
    f_sinh, f_sinhf, f_sinpi, f_sinpif, f_tanf, f_tanh, f_tanpi, f_tanpif, f_y0, f_y0f, f_y1,
    f_y1f,
};
