...
use pxfm::{
    ...
    f_cosf, f_cosh, f_coshf, f_cospi, f_cospif, f_cot, f_cotf, f_erff, f_exp, f_exp2, f_exp2f,
    ...
    f_log2p1f, f_log10, f_log10f, f_log10p1, f_log10p1f, f_logf, f_sec, f_secf, f_sin, f_sincos,
    f_sinf, f_sinh, f_sinhf, f_sinpi, f_sinpif, f_tanf, f_tanh, f_tanpi, f_tanpif,
};
